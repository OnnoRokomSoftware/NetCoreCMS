...
namespace NetCoreCMS.MatGallery.Services
{
    public class NccUserModuleService : IBaseService<NccUserModule>
    {
        ...
        public NccUserModule Get(long entityId, bool isAsNoTracking = false)
        {
        ...
        public List<NccUserModule> LoadAll(bool isActive = true, int status = -1, string name = "", bool isLikeSearch = false)
        {
