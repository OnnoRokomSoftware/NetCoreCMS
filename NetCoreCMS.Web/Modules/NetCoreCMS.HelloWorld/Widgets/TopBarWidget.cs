...
namespace NetCoreCMS.HelloWorld.Widgets
{
    public class TopBarWidget : IWidget
    {
        ...
        public string WidgetId { get { return "NetCoreCMS.HelloWorld.Widgets.TopBarWidget"; } }
        ...
        public TopBarWidget(IViewRenderService viewRenderService)
        {
