...
{
    public class SbrBoardService : IBaseService<SbrBoard>
    {
        private readonly SbrBoardRepository _entityRepository;

        public SbrBoardService(SbrBoardRepository entityRepository)
        {
            _entityRepository = entityRepository;
        }

        public SbrBoard Get(long entityId, bool isAsNoTracking = false)
        {
            return _entityRepository.Get(entityId);
        }

        public SbrBoard Save(SbrBoard entity)
        {
        ...
        public SbrBoard Update(SbrBoard entity)
        {
        ...
        public List<SbrBoard> LoadAll(bool isActive = true, int status = -1, string name = "", bool isLikeSearch = false)
        {
        ...
        private void CopyNewData(SbrBoard oldEntity, SbrBoard entity)
        {
