...
namespace NetCoreCMS.Themes.UnmeshBd.Lib
{
    public class MenuHelper
    {
        ...
        {
            var menus = GlobalConfig.Menus.Where(x => x.Position == position && (x.MenuLanguage == "" || x.MenuLanguage.ToLower() == currentLanguage.ToLower())).OrderBy(x => x.MenuOrder).ToList();
            var menuTxt = "";
